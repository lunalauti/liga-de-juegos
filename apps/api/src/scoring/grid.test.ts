...
describe('buildGrid', () => {
  ...
  it('ausencia con absence_policy "penalize" genera una celda con la penalización', () => {
    const grid = buildGrid({ members: MEMBERS, games: GAMES, days: DAYS, entries: [], blackouts: [], absencePolicy: 'penalize' });
  ...
  it('ausencia con absence_policy "ignore" no genera ninguna celda', () => {
    const grid = buildGrid({ members: MEMBERS, games: GAMES, days: DAYS, entries: [], blackouts: [], absencePolicy: 'ignore' });
